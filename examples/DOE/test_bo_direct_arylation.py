...
results_file_path = "direct_arylation_random_10_50_50.csv"
...
results_file_path = "direct_arylation_random_1_25_50.csv"
results_file = "seed,maximum observed yield" + "\n"
...
for num in random.sample(range(10 ** 6), 50):
    ...
    count += 1
    print("SEED HERE IS ", num)
    simulation_result = simulate(seed=num, RESULT_PATH='data/direct_arylation/experiment_index.csv', BATCH_SIZE=1, NUM_ROUNDS=25)
    results_file += str(num) + "," + str(simulation_result) + "\n"
...
results_file_path = "direct_arylation_random_2_50_50.csv"
results_file = "seed,maximum observed yield" + "\n"
...
for num in random.sample(range(10 ** 6), 50):
    ...
    count += 1
    print("SEED HERE IS ", num)
    simulation_result = simulate(seed=num, RESULT_PATH='data/direct_arylation/experiment_index.csv', BATCH_SIZE=2, NUM_ROUNDS=25)
    results_file += str(num) + "," + str(simulation_result) + "\n"
